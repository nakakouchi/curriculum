...
public abstract class BaseServlet extends HttpServlet {
	...
	//private static final修飾子：そのクラスでしかアクセスできない、かつクラスに１つである定数でありstaticにすることでメモリを抑えるメリットがある。
	/* 定数 */
...
//	バリデーション：妥当性の確認
	...
	protected boolean validateLogin(final HttpServletRequest request) throws IOException {
		...
		try {
			// FIXME Step-3-3: 社員情報管理サービス(EmployeeManagementService.java)より、社員情報を取得する処理を呼び出しなさい。
