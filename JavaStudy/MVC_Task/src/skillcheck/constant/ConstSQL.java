...
public final class ConstSQL {
    ...
    // ?useUnicode=true&characterEncoding=utf8 (文字化け阻止のコード)
    // ?useUnicode(ユニコード)=true&character(キャラクター)Encoding(エンコーディング)=utf8
    ...
    public static final String SELECT_BASE = " SELECT empid, name, mail, programinglanguage, comment from employee ";
